        ...
        <div class="card-body" dir="rtl">
            ...
            <form class="forms-sample">
              <div class="form-group">
                ...
                <input name="size" type="text" class="form-control" id="exampleInputName1" placeholder="size">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="input-group col-xs-12" dir="ltr">
                  ...
                  <span class="input-group-append">
                    <input type="file" class="file-upload-browse btn btn-warning" type="button"> </button>
                  </span>
                </div>
              </div>
              <div class="form-group">
